...
export const listOf: Doc = new Doc(
  ...
  [
    new ArgDoc(
      "p",
      "procedure?, returns `#t` if its argument is of the desired type",
    ),
  ],
...
export const sort: Doc = new Doc(
  ...
  [
    ...
    new ArgDoc(
      "lt?",
      "procedure?, returns `#t` if the first arg is less than the second",
    ),
  ],
...
export const withHandler: Doc = new Doc(
  ...
  "any",
  [
    new ArgDoc("h", "procedure?, a handler"),
    new ArgDoc("f", "procedure?, a function"),
    new ArgDoc("v", "any"),
  ],
