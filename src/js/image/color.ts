...
export function color(r: number, g: number, b: number, a: number): Rgb {
...
export function isRgbComponent(n: number): boolean {
...
export function rgbRed(rgba: Rgb): number {
  checkContract(arguments, contract('rgb-red', [rgbS]))
  return rgba.red
}

export function rgbGreen(rgba: Rgb): number {
  checkContract(arguments, contract('rgb-green', [rgbS]))
  return rgba.green
}

export function rgbBlue(rgba: Rgb): number {
  checkContract(arguments, contract('rgb-blue', [rgbS]))
  return rgba.blue
}

export function rgbAlpha(rgba: Rgb): number {
  checkContract(arguments, contract('rgb-alpha', [rgbS]))
  return rgba.alpha
}

export function rgbDistance(rgba1: Rgb, rgba2: Rgb): number {
...
export function hsv(...args: number[]): Hsv {
...
export function hsvHue(hsv: Hsv): number {
  checkContract(arguments, contract('hsv-hue', [hsvS]))
  return hsv.hue
}

export function hsvSaturation(hsv: Hsv): number {
  checkContract(arguments, contract('hsv-saturation', [hsvS]))
  return hsv.saturation
}

export function hsvValue(hsv: Hsv): number {
  checkContract(arguments, contract('hsv-value', [hsvS]))
  return hsv.value
}

export function hsvAlpha(hsv: Hsv): number {
  checkContract(arguments, contract('hsv-alpha', [hsvS]))
  return hsv.alpha
}

export function hsvComplement(h: Hsv): Hsv {
...
export function rgbHue(r: Rgb): number {
...
export function rgbSaturation(r: Rgb): number {
...
export function rgbDarker(rgba: Rgb): Rgb {
...
export function rgbLighter(rgba: Rgb): Rgb {
...
export function rgbRedder(rgba: Rgb): Rgb {
...
export function rgbBluer(rgba: Rgb): Rgb {
...
export function rgbGreener(rgba: Rgb): Rgb {
...
export function rgbGreyscale(rgba: Rgb): Rgb {
...
export function rgbPhaseshift(rgba: Rgb): Rgb {
...
export function rgbThicken(rgba: Rgb): Rgb {
...
export function rgbAdd(rgba1: Rgb, rgba2: Rgb): Rgb {
...
export function rgbSubtract(rgba1: Rgb, rgba2: Rgb): Rgb {
