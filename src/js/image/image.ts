...
export function withImageFile(callback: L.ScamperFn): ReactiveImageFile {
...
export function isReactiveImageFile (v: any): boolean {
  return L.isStructKind(v, 'reactive-image-file')
}

export function withImageFromUrl(url: string, callback: L.ScamperFn): HTMLElement {
...
export function pixelMap(fn: L.ScamperFn, canvas: HTMLCanvasElement): HTMLCanvasElement {
...
export function imageGetPixel(canvas: HTMLCanvasElement, x: number, y: number): L.Struct {
...
export function imageToPixels(canvas: HTMLCanvasElement): L.Struct[] {
...
export function pixelsToImage(pixels: L.Struct[], width: number, height: number): HTMLCanvasElement {
...
export function canvasSetPixels(canvas: HTMLCanvasElement, pixels: L.Struct[]): void {
