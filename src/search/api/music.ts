...
export const pitch: Doc = new Doc(
  ...
  ["modifications", "music", "predicates", "sound", "type check"]
)
...
export const durQ: Doc = new Doc(
  ...
  ["duration", "music", "predicates", "sound", "type check"]
)
...
export const noteValueQ: Doc = new Doc(
  ...
  ["music", "note", "predicates", "sound", "type check"]
)
...
export const modQ: Doc = new Doc(
  ...
  ["modifications", "music", "predicates", "sound", "typecheck"]
)
...
export const compositionQ: Doc = new Doc(
  ...
  ["music", "predicates", "sound", "type check"]
)
...
export const trigger: Doc = new Doc(
  ...
  ["constants", "interactive", "music", "sound"]
)
...
export const percussion: Doc = new Doc(
  ...
  ["constants", "modifications", "music", "sound"]
)
...
["modifications", "music", "duration", "sound"]
)
...
export const wn: Doc = new Doc(
  ...
  ["constants", "duration", "music", "sound"]
)
