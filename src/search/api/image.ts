...
export const shapeQ: Doc = new Doc(
  ...
  ["images", "predicates", "shapes", "type check"]
)
...
export const colorQ: Doc = new Doc(
  ...
  ["color", "hsv", "images", "predicates", "rgb", "type check"]
)
...
export const isRgbComponent: Doc = new Doc(
  ...
  ["color", "images", "predicates", "rgb", "type check"]
)
...
export const isColorName: Doc = new Doc(
  ...
  ["color", "images", "predicates", "type check"]
)
...
export const isHsv: Doc = new Doc(
  ...
  ["color", "images", "hsv", "predicates", "type check"]
)
...
export const canvasSetPixels: Doc = new Doc(
  ...
  ["canvas", "images", "mutations", "pixel", "predicates"]
)