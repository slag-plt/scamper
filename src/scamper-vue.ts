...
import { VueDisplay } from "./lpm/output/vue"

export class ScamperVue {
  display: VueDisplay
  prog: LPM.Prog | undefined
  machine: LPM.Thread | undefined

  constructor(display: VueDisplay, src: string, isTracing = false, isDrawing = false) {
