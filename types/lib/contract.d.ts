...
export declare const func: {
    predicate: (v: any) => v is L.ScamperFn;
    errorMsg: (actual: any) => string;
};
export declare const char: {
    predicate: (v: any) => v is L.Char;
    errorMsg: (actual: any) => string;
};
export declare const pair: {
    predicate: (v: any) => v is L.Pair;
    errorMsg: (actual: any) => string;
};
export declare const list: {
    predicate: (v: any) => v is L.List;
    errorMsg: (actual: any) => string;
};
export declare const nonemptyList: {
    predicate: (v: any) => v is L.Cons;
    errorMsg: (actual: any) => string;
};
