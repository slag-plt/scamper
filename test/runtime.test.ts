...
`, [
  ':5:0: Runtime error:',
  'A runtime error was encountered: hello',
  'In program: (error "hello")',
  '#f',
  ':4:6: Runtime error:',
  'A runtime error was encountered: hello',
  'In program: (error "hello")',
...
`, [
  ':0:0: Runtime error:',
  'string-length expected an string? in position 1 but a [object Object] was given',
  'In program: (string-length (list 1 2 3))',
  ':0:2: Runtime error:',
  '+ expected an number? in position 4 but a bye was given',
  'In program: (+ 1 2 3 "bye")',
  ':-1:-1: Runtime error:',
  'char-upcase expected an char? in position 1 but a h was given',
  'In program: ([object Function] "h")'
])
...
(test-case "epsilon equality failure"
  (=-eps 0.001) 3 5)
`, [
  '[[ Test "simple equality success" passed! ]]',
  '[[ Test "simple equality failure" failed!',
  'Expected: 1',
  'Actual: 2',
  ']]',
  '[[ Test "simple equality failure with computation" failed!',
  'Expected: 5',
  'Actual: 3',
  ']]',
  '[[ Test "epsilon equality success" passed! ]]',
  '[[ Test "epsilon equality failure" failed!',
  'Expected: 3',
  'Actual: 5',
  ']]'
])
...
(tree-to-list t1)
`, [
  '(struct node (struct leaf "a") (struct node (struct leaf "b") (struct leaf "c")))',
  '"b"',
  '3',
  '(list "a" "b" "c")'
])
